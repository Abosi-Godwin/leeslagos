    ...
    <>
      ...
      <div className="py-16 px-5">
        <div className="relative">
          <p className="absolute top-2 right-0 p-1 bg-white">{product.tag}</p>
        ...
        <div className="py-6">
          <div className="flex gap-1.5">
            <p className="font-bold capitalize text-neutral-700">color:</p>
            <select
              className="outline-none rounded-md
                        bg-transparent"
            >
              <option value="select">select</option>
              <option value={product.details.color}>{product.details.color}</option>
            </select>
          </div>
          <div className="flex gap-1.5">
            <p className="font-bold capitalize text-neutral-700">Size:</p>
